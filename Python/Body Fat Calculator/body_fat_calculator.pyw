...
def calculate():
    ...
    density=1.10938-(0.0008267*fat_total)+(0.0000016*fat_squared)-(0.0002574*age)
...
# ----- Body Fat Area -----
Label(root,text="Body Fat Calculator For Men",font="Helvetica 10 bold",bg="lightgrey",width=45,height=2).grid(row=0,columnspan=3)
...
Button(root,text="Calculate",width=12,font="Helvetica 10 bold",bg="#DEDEDE",command=calculate).grid(row=11)

# ----- Results Area -----
Label(root,text="Results",font="Helvetica 10 bold",bg="lightgrey",width=45,height=2).grid(row=13,columnspan=3,pady=(20,10))
...
Button(root,text="EXIT",font="Helvetica 10 bold",bg="#DEDEDE",padx=20,command=root.destroy).grid(row=19,columnspan=3,pady=(10,20))
